...
library Position {
  ...
  /** Get x */
  function getX(bytes32 entity) internal view returns (uint32 x) {
  ...
  function getX(IStore _store, bytes32 entity) internal view returns (uint32 x) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Set x */
  function setX(bytes32 entity, uint32 x) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function setX(IStore _store, bytes32 entity, uint32 x) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Get y */
  function getY(bytes32 entity) internal view returns (uint32 y) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function getY(IStore _store, bytes32 entity) internal view returns (uint32 y) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Set y */
  function setY(bytes32 entity, uint32 y) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function setY(IStore _store, bytes32 entity, uint32 y) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  /** Get the full data */
  function get(bytes32 entity) internal view returns (uint32 x, uint32 y) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function get(IStore _store, bytes32 entity) internal view returns (uint32 x, uint32 y) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((entity));
  ...
  function set(bytes32 entity, uint32 x, uint32 y) internal {
  ...
  function set(IStore _store, bytes32 entity, uint32 x, uint32 y) internal {
    bytes memory _data = encode(x, y);
